...
public class TKTransitionSubmitButton : UIButton, UIViewControllerTransitioningDelegate {
  ...
  @IBInspectable
  public var spinnerColor: UIColor = UIColor.whiteColor() {
    didSet {
  ...
  @IBInspectable
  public var normalCornerRadius:CGFloat? = 0.0{
    didSet {
  ...
  func setup() {
    ...
    self.backgroundColor = UIColor(red: 204/255, green: 0/255, blue: 52/255, alpha: 1)
    spiner.spinnerColor = spinnerColor
  }
